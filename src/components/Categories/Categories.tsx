...
export default function Categories() {
  const sampleCategories = [
    ...
    { id: 2, name: 'Fresh Vegetables', image: '/images/categories/category1.png' },
    ...
    { id: 6, name: 'Beauty & Health', image: '/images/categories/category5.png' },
    { id: 7, name: 'Bread & Bakery', image: '/images/categories/category6.png' },
    { id: 8, name: 'Baking Needs', image: '/images/categories/category7.png' },
    { id: 9, name: 'Cooking', image: '/images/categories/category8.png' },
    { id: 10, name: 'Diabetic Food', image: '/images/categories/category9.png' },
    { id: 11, name: 'Dish Detergents', image: '/images/categories/category10.png' },
    { id: 12, name: 'Oil', image: '/images/categories/category11.png' },
  ];

  return (
    <div className="py-10 px-4">
        <Title title="Category" description="Shop By Top Categories"/>
